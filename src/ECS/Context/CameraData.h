...
namespace almost
{
  ...
  static glm::vec2 GetFov2(float horFov, glm::vec2 renderArea)
  {
    return glm::vec2(horFov, horFov / renderArea.x * renderArea.y);
  }
  static glm::mat4 GetViewProjMatrix(glm::vec2 pos, float ang, glm::vec2 fov)
  {
  ...
  static glm::vec2 Project(glm::vec2 pos, float ang, glm::vec2 fov, glm::vec2 worldPos)
  {
  ...
  static glm::vec2 Unproject(glm::vec2 pos, float ang, glm::vec2 fov, glm::vec2 screenPos)
  {
    glm::vec2 rightVec = glm::vec2(cos(ang), sin(ang));
    glm::vec2 upVec = glm::vec2(-rightVec.y, rightVec.x);
  ...
  static AABB2 GetCameraAABB(glm::vec2 pos, float ang, glm::vec2 fov)
  {
    AABB2 aabb;
    glm::vec2 rightVec = glm::vec2(cos(ang), sin(ang));
    glm::vec2 upVec = glm::vec2(-rightVec.y, rightVec.x);
